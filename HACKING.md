...
hidden if the `gcc-project_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `gcc-project_DEVELOPER_MODE` to the configure
...
Runs the executable target `gcc-project_exe`.
